...
URL = "https://hot-bot-dljs.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://hot-bot-dljs.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://hot-bot-dljs.onrender.com/".format(FQDN)
else:
    URL = "https://hot-bot-dljs.onrender.com/".format(FQDN)
