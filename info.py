...
auth_channel = environ.get('AUTH_CHANNEL', '-1002073080193')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/viewa2zMovie')
...
URL = "https://maria-luis-w9fo.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://maria-luis-w9fo.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://maria-luis-w9fo.onrender.com/".format(FQDN)
else:
    URL = "https://maria-luis-w9fo.onrender.com/".format(FQDN)
