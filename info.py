...
URL = "https://maria-6t8v.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://maria-6t8v.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://maria-6t8v.onrender.com/".format(FQDN)
else:
    URL = "https://maria-6t8v.onrender.com/".format(FQDN)
